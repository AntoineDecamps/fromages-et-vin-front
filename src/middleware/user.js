...
export default (store) => (next) => (action) => {
  switch (action.type) {
    case LOGIN: {
      ...
      axios.post('http://34.203.201.178/fromages-et-vin/Cheese-and-Wine/public/api/login', {
        username,
        password,
      })
        .then((response) => {
    ...
    case LOGOUT: {
      ...
      axios.post('http://34.203.201.178/fromages-et-vin/Cheese-and-Wine/public/api/logout', {})
        .then((response) => {
    ...
    case GET_USERS: {
      axios.get('http://34.203.201.178/fromages-et-vin/Cheese-and-Wine/public/api/users')
        .then((response) => {
