  ...
  <div className="detail">
    <Parallax speed={-5}>
      <div className="detail__picture">
        ...
        <img src={wine} alt="" className="detail__image animate__animated animate__bounceInLeft animate_delay-1s" />
